using Ship.Ses.Transmitter.Application.Customer.ChangeEmail;
...
namespace Ship.Ses.Transmitter.Application.UnitTests.Customer.ChangeEmailTests
{
    public class ChangeEmailCommandHandlerTests
    {
        ...
        public async Task Should_Throw_CustomerNotFoundApplicationException_When_Customer_Does_Not_Exist()
        {
            ...
            _customerRepositoryMock.Setup(repo => repo.GetAsync(customerId, default)).ReturnsAsync((Ship.Ses.Transmitter.Domain.Customers.Customer?)null);
